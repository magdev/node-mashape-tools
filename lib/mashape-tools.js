...
var extend = require('xtend'),
    ...
    defaultConfig = {
        ...
        /** List of allowed IPs, i.e. load balancers */
    ...
    ipFilter: function(config) {
        ...
        return function(req, res, next) {
            try {
                ...
                if ((!iplist || !iplist.length) || (!config.ipWhitelist || !config.ipWhitelist.length)) {
                ...
                if (config.ipWhitelist && config.ipWhitelist.indexOf(ip) !== -1) {
                    if (config.log) {
